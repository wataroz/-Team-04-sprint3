...
| Techit | UX/UI | Test User กรอกรายจ่าย บันทึกลง DB & Dashboard chart | branches:feature/flask-react/ux_ui/styles.css | Done:Test User กรอกรายจ่าย & บันทึกลง DB ผ่าน / Doing:LINE Bot alert UI, HTML Prototype / Blocked:- |
...
| Techit | UX/UI | เพิ่มปุ่มเอาไว้ Reset ค่า Statement & บันทึก Video การทำงาน | Demo Website UI & GitHub Repository | Done: Reset Button & LINE Bot / Doing:- / Blocked:-|
