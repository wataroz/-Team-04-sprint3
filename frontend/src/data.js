...
const I18N = {
  ...
  upload_password_label:       { th: 'รหัส PDF (ถ้ามี)', en: 'PDF Password (if any)' },
  upload_password_placeholder: { th: 'เว้นว่างถ้าไฟล์ไม่ติดรหัส', en: 'Leave blank if not encrypted' },
  upload_password_hint:        { th: 'ธนาคารมักใช้รหัส 4 ตัวท้ายบัตรปชช., วันเกิด, หรือเลขที่บัญชี', en: 'Bank PDFs often use last 4 digits of ID, birth date, or account number.' },
  ...
  import_result_created: { th: 'เพิ่ม {n} รายการสำเร็จ', en: 'Imported {n} entries' },
  import_result_partial: { th: 'เพิ่ม {n} รายการ · ข้ามรายการซ้ำ {m} รายการ', en: 'Imported {n} entries · skipped {m} duplicates' },
  import_result_all_dup: { th: 'ไฟล์นี้ถูกอัปโหลดไปแล้ว ไม่มีรายการใหม่', en: 'This file was already uploaded — no new entries' },
  undo_import:           { th: 'ยกเลิกการนำเข้าครั้งล่าสุด', en: 'Undo last import' },
  undo_confirm:          { th: 'ยืนยันยกเลิกการนำเข้านี้? รายการทั้งหมดในไฟล์จะถูกลบ', en: 'Undo this import? All entries from the file will be removed.' },
  undo_success:          { th: 'ลบ {n} รายการแล้ว', en: 'Removed {n} entries' },
  undo_failed:           { th: 'ยกเลิกไม่สำเร็จ ลองอีกครั้ง', en: 'Undo failed — please try again' },
  // Reset Statement (Day 4)
  reset_btn:          { th: 'รีเซ็ต',                                 en: 'Reset' },
  reset_title:        { th: 'รีเซ็ต Statement?',                       en: 'Reset Statement?' },
  reset_lead:         { th: 'การดำเนินการนี้จะล้างข้อมูล Statement ทั้งหมดและเริ่มต้นใหม่', en: 'This will clear all statement data and start fresh.' },
  reset_will_delete:  { th: 'สิ่งที่จะถูกลบ',                            en: 'Will be deleted' },
  reset_will_keep:    { th: 'สิ่งที่จะเก็บไว้',                           en: 'Will be kept' },
  reset_d_txs:        { th: 'รายการรายจ่ายและรายรับทั้งหมด',              en: 'All transactions (income & expense)' },
  reset_d_imports:    { th: 'ประวัติการนำเข้าไฟล์ Statement',            en: 'Import history' },
  reset_d_notifs:     { th: 'การแจ้งเตือนทั้งหมด',                       en: 'All notifications' },
  reset_k_budgets:    { th: 'งบประมาณรายหมวดที่ตั้งไว้',                  en: 'Category budgets' },
  reset_k_account:    { th: 'บัญชีผู้ใช้และการตั้งค่า',                    en: 'Your account & preferences' },
  reset_k_line:       { th: 'การเชื่อมบัญชี LINE',                      en: 'LINE account linking' },
  reset_warning:      { th: 'การดำเนินการนี้กู้คืนไม่ได้',                  en: 'This action cannot be undone.' },
  reset_cancel:       { th: 'ยกเลิก',                                 en: 'Cancel' },
  reset_confirm:      { th: 'ยืนยันรีเซ็ต',                            en: 'Confirm reset' },
  reset_doing:        { th: 'กำลังรีเซ็ต...',                          en: 'Resetting…' },
  reset_success:      { th: 'รีเซ็ตเสร็จ · ลบ {n} รายการ · {m} การนำเข้า · {k} การแจ้งเตือน', en: 'Reset complete · {n} txs · {m} imports · {k} notifications removed' },
  reset_failed:       { th: 'รีเซ็ตไม่สำเร็จ ลองอีกครั้ง',                en: 'Reset failed — please try again' },
